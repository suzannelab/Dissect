# original module written by Didier Vibert (LAM, Marseille)
# This version was modified by Florian Sarron (IAP) : added separate
# treatment of 2D and 3D skeleton for some functions + corrected a bug in
# "follow_filament_to_cp" function + added distance_to_node() function.
